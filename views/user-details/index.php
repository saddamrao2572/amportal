                    ...
                    <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'header'=>"Actions",
                                    'template'=>'  {active}{deactive} {view}{delete}',
                                    'buttons'=>[
                                        
                                        'deactive' => function ($url, $model) {
                                            $user=\app\models\User::find()->Where(['id' => $model->user_id])->one();
                                            if ($user->status==1) {
                                                return Html::a('<button class="btn btn-outline-danger mb-1 btn-xs">Deactivate</button>', $url, [
                                        ...
                                        'active' => function ($url, $model) {
                                            $user=\app\models\User::find()->Where(['id' => $model->user_id])->one();
                                                if ($user->status==0) {
                                                return Html::a('<button class="btn btn-outline-success mb-1 btn-xs">Activate</button>', $url, [
                                        ...
                                        'view' => function ($url, $model) {
                                            return Html::a('<button class="btn btn-outline-info mb-1 btn-xs">Profile</button>', $url, [
                                        ...
                                        'delete' => function ($url, $model) {
                                            return Html::a('<button class="btn btn-outline-danger mb-1 btn-xs">Delete</button>', $url, [
