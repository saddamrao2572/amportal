...
$this->title = Yii::t('app', 'Assign Task groups');
				...
				<div class="float-md-right text-zero">
				   <?=             Html::a('<i class="simple-icon-action-undo"> </i> '.
                    ...
                    ['class' => 'btn btn-light default btn-lg mr-1']) ?>  
                     <a href="<?=url::to(['/groups/index'])?>" class="btn btn-primary default btn-lg " style="font-size: 12px"> <i class="simple-icon-note"></i> Manage groups</a>
