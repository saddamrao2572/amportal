            ...
            <div class="row">
                <div class="col-md-12">
                  ...
                  <?= $form->field($model, 'task_id')
							->dropDownList(
								ArrayHelper::map(\app\models\Task::find()->all(), 'id', 'title'),          // Flat array ('id'=>'label')
								['prompt'=>'Select Task...','class'=>'form-control dropdown' ]    // options
							);
					 ?>
					<?= $form->field($model, 'groupIds')->widget(Select2::classname(), [
					'data' => ArrayHelper::map(\app\models\Groups::find()->all(), 'id', 'title'),
					'options' => [
