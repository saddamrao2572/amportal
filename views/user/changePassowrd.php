...
<div class="row">
		...
		<div class="sidebar">
			...
			<?php $form = ActiveForm::begin([ 'options'=>['enctype'=>'multipart/form-data']]); ?> 
				<?php Pjax::begin(['id' => 'profile-image-pjax']); ?>
					<div id="profileDiv">
						...
						<a href="javascript://" class='change-picture'>Chnage Picture</a>
					</div>
				<?php Pjax::end(); ?>
			...
			<div class="widget">
				<ul class="menu-advanced">
					...
					<li><a href="<?= Url::to(['/user/password','id'=>Yii::$app->util->encrypt($model->id)]); ?>"><i class="fa fa-key"></i> Password</a></li>
    ...
    <div class="col-sm-8 col-lg-9">
        <div class="content">
			...
			<?php } else if($view == 'user/password'){ ?>
				<?= $this->render('_change',['model'=>$model]) ?>
			<?php } ?>
		</div><!-- /.content -->
	</div><!-- /.col-* -->
</div><!-- /.row -->
