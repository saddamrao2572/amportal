...
if (\Yii::$app->user->can('app_company_view', ['route' => true])) {
		...
		<div class="col-12 col-lg-12">
			<div class="mb-2">
				...
				<div class="float-md-right text-zero">
				   <a href="<?=url::to(['company/create'])?>" class="btn btn-primary default btn-lg mb-1" style="font-size: 12px"> <i class="simple-icon-plus"></i> Add New Company</a>
                ...
                <div class="card-body">
                    <div class="dashboard-quick-post">
						...
						'urlCreator' => function ($action, $model, $key, $index) {
							if ($action === 'edit') {
								$url = Url::to(['/company/update','id'=>$model->id]); // your own url generation logic
								return $url;
							}
							if ($action === 'delete') {
								$url = Url::to(['/company/delete','id'=>$model->id]); // your own url generation logic
								return $url;
							}
							
							if ($action === 'view') {
								$url = Url::to(['/company/view/','id'=>$model->id]); // your own url generation logic
								return $url;
							}
